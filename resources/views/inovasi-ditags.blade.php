            ...
            <div class="container">
              ...
              <div class="row gy-4">
                ...
                <div class="portfolio-info">
                    ...
                    <ul>
                      <li><strong>Inovasi</strong>: DITAGS (Digitalisasi Pencatatan Geser Seru)</li>
                      <li><strong>Project date</strong>: 2021</li>
                      <li><strong>Laporan inovasi</strong>: <a href="#">DITAGS (Digitalisasi Pencatatan Geser Seru)</a></li>
                    </ul>
                  </div>
                </div>
                <div class="portfolio-description">
                    <h2 style="text-align: center">DITAGS</h2>
                    <p style="text-align: center">
                      DIGITALISASI PENCATATAN GESER SERU
                    </p>
